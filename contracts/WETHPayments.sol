...
contract WETHPayments is ReferrerManagement {
    ...
    function _transferWETH(address to, uint256 amount) internal transferCompleted(to, amount) {
        IERC20(WETH).transfer(to, amount);
    }

    function _transferWETHFrom(address from, address to, uint256 amount) internal transferCompleted(to, amount) {
